...
dada2 <- read_delim(file.path(data_dir, "Fig3_dada2_results.txt"),show_col_types = FALSE)
```


```{r}
## Load count data
counts <- read_delim(file.path(data_dir, "Fig3_count_data.txt"), show_col_types = FALSE) %>%
